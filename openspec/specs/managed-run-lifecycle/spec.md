# managed-run-lifecycle Specification

## Purpose
Defines the shared lifecycle contract for managed runtime runs, including stop,
remove, and optional graceful control metadata.
