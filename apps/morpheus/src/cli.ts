...
function usage() {
  writeStdout(
    [
      ...
      "  morpheus --config <workspace-root>/morpheus.yaml workflow run --name <workflow> --json",
      "",
      "Examples:",
      "  morpheus --config <workspace-root>/morpheus.yaml workflow inspect --name <workflow> --json",
      "  morpheus --config <workspace-root>/morpheus.yaml workflow logs --name <workflow> --stage <stage-id>",
      "",
      "Notes:",
