...
- Treat UI and automation clients as Morpheus-CLI consumers first; they should
  read workflow instances, events, inspect data, and logs through Morpheus
  JSON commands rather than reconstructing `workspace/workflows/...` directly.
