...
bridge_source="${MORPHEUS_LIBAFL_QEMU_BRIDGE_SOURCE:?}"
bridge_library="${MORPHEUS_LIBAFL_QEMU_BRIDGE_LIBRARY:?}"
bridge_data_dir="${MORPHEUS_LIBAFL_QEMU_BRIDGE_DATA_DIR:?}"
