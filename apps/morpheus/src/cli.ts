...
function usage() {
  writeStdout(
    [
      ...
      "",
      "Examples:",
      "  ./bin/morpheus --config projects/<project>/morpheus.yaml workflow inspect --name <workflow> --json",
      "  ./bin/morpheus --config projects/<project>/morpheus.yaml workflow logs --name <workflow> --step <step-id>",
      "",
      "Notes:",
