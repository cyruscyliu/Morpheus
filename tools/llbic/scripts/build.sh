...
# Managed path is tools/llbic/src (cache.src / __cache_src). Legacy "sources"
# dir name is normalized to src by Morpheus path resolution.
sources_dir="${MORPHEUS_LLBIC_SOURCE:-${ROOT_DIR}/src}"
